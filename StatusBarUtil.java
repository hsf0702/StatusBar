package com.fqxyi.statusbar.utils;
...
public class StatusBarUtil {
    ...
    public static void createStatusView(Activity activity) {
        ...
        // 设置背景色
        statusView.setBackgroundColor(StatusBarUtil.getStatusBarColor(activity));
        // 添加 statusView 到布局中
    ...
    public static void hideStatusView(Activity activity, boolean hide) {
        ...
        if (hide) {
            ...
            firstParams.topMargin = StatusBarUtil.getStatusBarHeight(activity);
